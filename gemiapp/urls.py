...
urlpatterns = [
    ...
    path("organizations/<int:organization_id>/radars/new/", organization_views.workspace_radar_create,
         name="organization_radar_create"),
    path("organizations/<int:organization_id>/radars/<int:radar_id>/edit/", organization_views.workspace_radar_edit,
         name="organization_radar_edit"),
    path("organizations/<int:organization_id>/radars/<int:radar_id>/active/", organization_views.workspace_radar_active,
         name="organization_radar_active"),
