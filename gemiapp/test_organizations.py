...
class SchemaTests(TestCase):
    ...
    def test_organization_fields_carry_no_billing_company_or_tenant_data(self):
        ...
        # Reverse relations only from organization-owned tables: members, profile and (C2) the ICP.
        from .models import OrganizationICP

        for field in Organization._meta.get_fields():
            if field.is_relation:
                self.assertIn(field.related_model, (OrganizationMember, OrganizationProfile, OrganizationICP))
