...
- 2026-08-19: Ενισχύθηκε ο μηχανισμός Infinite Scroll (με multi-trigger scroll & IntersectionObserver) και ενεργοποιήθηκαν οι clickable σύνδεσμοι ονομάτων στο Dashboard (`dashboard_rows.html`), καθώς και η προβολή email για λογαριασμούς Superadmin/Staff & συνδρομητές στο `templates/companies/detail.html`.
