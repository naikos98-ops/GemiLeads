...
- 2026-08-19: Διορθώθηκε το σφάλμα 404 κατά το κλικ σε γενικές εγγραφές ΓΕΜΗ από το Dashboard (`company_detail`): Η προβολή `company_detail` εκτελεί πλέον δυναμικό `get_or_create` του `UserCompanyLead` για οποιαδήποτε έγκυρη εταιρεία ΓΕΜΗ, επιτρέποντας την απρόσκοπτη προβολή των στοιχείων της. Όλα τα 44 unit tests περνούν επιτυχώς.
