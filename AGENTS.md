...
- 2026-08-19: Ολοκληρώθηκαν 4 νέες ζητούμενες προσθήκες: α) Κουμπί προβολής/απόκρυψης κωδικού (Eye toggle `👁️`) στις φόρμες Login & Signup, β) Καθαρή μορφοποίηση του κειμένου οδηγιών κωδικού στην εγγραφή, γ) Προβολή banner Δωρεάν Πρόσβασης (Complimentary Access) στη σελίδα τιμολόγησης με την ακριβή ημερομηνία λήξης ή «Μόνιμη (Για πάντα)» και απόκρυψη των κουμπιών αγοράς, δ) Δημιουργία management command `import_2026_data` για την εισαγωγή όλων των εγγραφών ΓΕΜΗ από 01/01/2026 έως σήμερα.
