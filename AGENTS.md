...
- 2026-08-19: Αυξήθηκε το `max_length` του πεδίου `DigestDelivery.frequency` από 10 σε 30 χαρακτήρες (migration `0014_alter_digestdelivery_frequency.py`), επιλύοντας το σφάλμα PostgreSQL `value too long for type character varying(10)` κατά τη χειροκίνητη αποστολή εγγραφών (`manual_yesterday`).
